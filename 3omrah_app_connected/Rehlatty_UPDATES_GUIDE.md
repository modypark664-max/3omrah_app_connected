...
> ملاحظة: اسم التطبيق تم تحديثه إلى Rehlatty، بينما تبقى أسماء بعض المجلدات المحلية القديمة مثل `3OMRAH_APP` و `3omrah_backend` للتوافق مع بنية المشروع الحالية.
